...
#ifndef gilloux
#define OFFSET 0xF00    // CFF si mux -- 800..FFF 
#else
...
//#define manuel		// definition manuelle des bornes, ou distribution 
//#define manuel                        //   equidistante entre FSTART et FSTOP sur NBPICS
...
#define NBMOY_MAX   (16)  // nbre de moyenne(s) : 1..16
#define NBPICS_MAX  (2)  // nbre de resonateur(s) par antenne : 1..12
#define NBSTEPS_MAX (168) // nbre de pas de freq par resonance : 32..128
...
void safran_dac(char ,unsigned short );
