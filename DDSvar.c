...
//----------------------------------------------------------------------------//
int safran_temperature=1;    // sortie DAC safran
...
int RS_BAUDRATE=57600;  // debit de communication (bauds)
...
unsigned int NBMOY=(16);    // DOIT etre inferieur ou egal a NBMOY_MAX
unsigned int NBPICS=(2);   // DOIT etre inferieur ou egal a NBPICS_MAX
unsigned int NBSTEPS=(128); // NBSTEPS tq pas de freq=largeur mi-hauteur/3=f0/Q/3 
...
//unsigned int FSTOP =(0x2c290000);  // 435.00 MHz SAFRAN
...
/// unsigned int FSTOP=(0x33333300); // 440 MHz sakharov
...
//unsigned int FSTART  =(0x30a3d700); // 438.00 MHz 
...
int NBMOY=(8);    // DOIT etre inferieur ou egal a NBMOY_MAX
unsigned int NBPICS=(4); // 12 ou 30   // DOIT etre inferieur ou egal a NBPICS_MAX
int NBSTEPS=(68); // NBSTEPS tq pas de freq=largeur mi-hauteur/3=f0/Q/3  
...
// SAFRAN 200229 -> 210218 ajout 2 res de fin  // 432.8     433.6       435.0      436.1
unsigned int Fintsta[ANTENNES_MAX*NBPICS_MAX]={0x29FBE770,0x2B020C50,0x2CCCCCD0,0x2E354000};
unsigned int Fintsto[ANTENNES_MAX*NBPICS_MAX]={0x2B020C50,0x2C49BA60,0x2E354000,0x2F5C28F5};
                                               // 433.6    434.6        436.1       437
                                               // 437        451
//unsigned int Fintsta[ANTENNES_MAX*NBPICS_MAX]={0x2F5C0000,0x4147A000};           
//unsigned int Fintsto[ANTENNES_MAX*NBPICS_MAX]={0x33333330,0x451eb000};
                                               // 440        454
 
// Ecole de l'Air                                  430      431         433        434        438.0      439     
//unsigned int Fintsta[ANTENNES_MAX*NBPICS_MAX]={0x26666670,0x27AE1480,0x2A3D70A0,0x2B851EB0,0x30A3D710,0x31EB8520}; 
//unsigned int Fintsto[ANTENNES_MAX*NBPICS_MAX]={0x27AE1480,0x28F5C290,0x2B851EB0,0x2CCCCCD0,0x31EB8520,0x33333330};
//                                                 431      432         434        435        439       440
...
int A0[ANTENNES_MAX*NBPICS_MAX/2]={-3100,    -2972,    -3599   }; //,    -4085}; // A0 normal *10 
int A1[ANTENNES_MAX*NBPICS_MAX/2]={30639765, 31868012, 39203994}; //, 46645469}; // A1 normal *1E2 
int A2[ANTENNES_MAX*NBPICS_MAX/2]={-24806,   -24428,   -27993  }; //,   -30948}; // A2 normal *1E5 
